...
title: 3. 酒店预订微服务
description: 介绍如何基于聚合根实现酒店房间预订的微服务
---

# 酒店预订微服务
下面我们将根据架构图构建一个初步的酒店房间的预订服务，您可以通过该案例对Phoenix有更深的了解。

![image](../../assets/phoenix/quick-start/hotel-part-1.png)
...
## 消息定义
关于Command和Event解释可以[参考文档](/docs/phoenix-core/phoenix-core-event-souring)。
...
## 聚合根定义
聚合根是我们事件处理和事件存储的重要枢纽，详情参见：[实体聚合根](/docs/phoenix-core/phoenix-core-entity-aggregate)
